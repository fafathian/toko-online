...
namespace App\Filament\Resources\Products; // Pastikan namespace teratas tidak ikut terhapus
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('store.name')
                    ->label('Nama Toko')
                    ->searchable() // Agar Admin bisa mencari berdasarkan nama toko
                    ->sortable()
                    ->badge()      // (Opsional) Memberikan efek visual seperti label/tag
                    ->color('info'),
